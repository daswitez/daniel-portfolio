  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-[0.03]">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-blue-500 via-violet-500 to-cyan-500 blur-[120px]" />
      </div>
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-semibold tracking-tight text-[#1a1a1a] mb-8">
            Sobre mí
          </h2>
        </motion.div>
        ...
        >
          {/* Glass card */}
          <div className="relative p-10 md:p-14 bg-white/60 backdrop-blur-xl border border-black/5 rounded-3xl shadow-2xl">
            <div className="relative z-10">
              <p className="text-xl md:text-2xl text-[#1a1a1a]/80 leading-relaxed mb-6">
